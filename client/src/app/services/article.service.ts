...
import {apiArticleGetAllGet$Json, apiArticleGetRecentNumberGet$Json} from '../api/functions';
...
export class ArticleService {
  ...
  getAll() : Observable<ArticleListDto[]> {
    return apiArticleGetAllGet$Json(this.http, this.apiConfig.rootUrl).pipe(
      map(response => {
