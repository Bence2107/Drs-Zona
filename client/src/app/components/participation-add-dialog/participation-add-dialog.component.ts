...
import {ConstructorsServiceService} from '../../services/constructors-service.service';
...
export class ParticipationAddDialogComponent implements OnInit {
  ...
  private driverService = inject(DriverServiceService);
  private constructorService = inject(ConstructorsServiceService);
